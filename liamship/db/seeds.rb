...
gsbs2 = GameShip.new(game_id: 1, player_id: 2, ship_id: bs.id)
gslc2 = GameShip.new(game_id: 1, player_id: 2, ship_id: lc.id)
gsls2 = GameShip.new(game_id: 1, player_id: 2, ship_id: ls.id)
gslsub2 = GameShip.new(game_id: 1, player_id: 2, ship_id: lsub.id)
gslf2 = GameShip.new(game_id: 1, player_id: 2, ship_id: lf.id)
...
p1_ships = GameShip.where(player_id: 1)
 ...
 2.times { |i| p1_ships[2].coordinates << Coordinate.find_by(id: i+21)}
 3.times { |i| p1_ships[3].coordinates << Coordinate.find_by(id: i+31)}
 3.times { |i| p1_ships[4].coordinates << Coordinate.find_by(id: i+41)}
...
p2_ships = GameShip.where(player_id: 2)
 ...
 2.times { |i| p2_ships[2].coordinates << Coordinate.find_by(id: i+21)}
 3.times { |i| p2_ships[3].coordinates << Coordinate.find_by(id: i+31)}
 3.times { |i| p2_ships[4].coordinates << Coordinate.find_by(id: i+41)}
